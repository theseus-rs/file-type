...
pub(crate) const PRONOM_49: FileFormat = FileFormat {
    id: 49,
                ...
                regex: Regex {
                    tokens: &[
                        ...
                        Token::Literal(&[
                            ...
                            0x6F, 0x63, 0x53, 0x65, 0x74, 0x73, 0x3A,
                        ]),
                        Token::Any(&[&[Token::Literal(&[0x20, 0x41])], &[Token::Literal(&[0x41])]]),
                        Token::Literal(&[
                            0x64, 0x6F, 0x62, 0x65, 0x5F, 0x49, 0x6C, 0x6C, 0x75, 0x73, 0x74, 0x72,
                            0x61, 0x74, 0x6F, 0x72, 0x5F, 0x31, 0x2E,
                        ]),
                        Token::Any(&[
                            &[Token::Literal(&[0x30])],
                            &[Token::Literal(&[0x31])],
