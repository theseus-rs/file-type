...
pub(crate) const PRONOM_1138: FileFormat = FileFormat {
    id: 1_138,
            ...
            regex: Regex {
                tokens: &[
                    ...
                    Token::Any(&[
                        ...
                        &[Token::Literal(&[
                            0x4C, 0x6F, 0x67, 0x20, 0x41, 0x53, 0x43, 0x49, 0x49, 0x20, 0x53, 0x74,
                            0x61, 0x6E, 0x64, 0x61, 0x72, 0x64,
                        ])],
                        &[Token::Literal(&[
                            0x6C, 0x6F, 0x67, 0x20, 0x41, 0x53, 0x43, 0x49, 0x49, 0x20, 0x53, 0x74,
                            0x61, 0x6E, 0x64, 0x61, 0x72, 0x64,
                        ])],
                        &[Token::Literal(&[0x4C, 0x41, 0x53])],
                    ]),
