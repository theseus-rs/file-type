...
pub(crate) const PRONOM_2192: FileFormat = FileFormat {
    id: 2_192,
        ...
        byte_sequences: &[ByteSequence {
            ...
            regex: Regex {
                tokens: &[
                    ...
                    Token::Literal(&[0x78, 0x6D, 0x6C, 0x6E, 0x73, 0x3A, 0x78, 0x64, 0x6F, 0x3D]),
                    Token::Any(&[&[Token::Literal(&[0x22])], &[Token::Literal(&[0x27])]]),
                    Token::Literal(&[
                        0x68, 0x74, 0x74, 0x70, 0x3A, 0x2F, 0x2F, 0x77, 0x77, 0x77, 0x2E, 0x78,
                        0x64, 0x6F, 0x6D, 0x65, 0x61, 0x2E, 0x64, 0x65,
                    ]),
                    Token::Any(&[&[Token::Literal(&[0x22])], &[Token::Literal(&[0x27])]]),
                ],
            },
