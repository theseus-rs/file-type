...
pub(crate) const PRONOM_787: FileFormat = FileFormat {
    id: 787,
    ...
    internal_signatures: &[InternalSignature {
        byte_sequences: &[
            ByteSequence {
                ...
                offset: Some(0),
                regex: Regex {
                    tokens: &[Token::Literal(&[0x25, 0x50, 0x44, 0x46, 0x2D])],
                },
            },
            ByteSequence {
                ...
                regex: Regex {
                    tokens: &[
                        ...
                        Token::Literal(&[
                            0x28, 0x43, 0x47, 0x41, 0x54, 0x53, 0x2E, 0x31, 0x32, 0x2F, 0x31, 0x2D,
                            0x31, 0x39, 0x39, 0x39, 0x29,
                        ]),
                    ],
                },
            },
