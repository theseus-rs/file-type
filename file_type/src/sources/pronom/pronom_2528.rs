...
pub(crate) const PRONOM_2528: FileType = FileType {
            ...
            Signature {
                byte_sequences: &[ByteSequence {
                    ...
                    regex: Regex {
                        tokens: &[
                            Token::Literal(&[
                                0x23, 0x20, 0x41, 0x52, 0x43, 0x2F, 0x49, 0x4E, 0x46, 0x4F, 0x20,
                                0x66, 0x69, 0x6C, 0x65, 0x20, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65,
                                0x64, 0x20, 0x66, 0x72, 0x6F, 0x6D, 0x20, 0x45, 0x52, 0x20, 0x4D,
                                0x61, 0x70, 0x70, 0x65, 0x72,
                            ]),
                ...
                byte_sequences: &[ByteSequence {
                    ...
                    regex: Regex {
                        tokens: &[
                            ...
                            Token::Literal(&[
                                0x0A, 0x42, 0x41, 0x4E, 0x44, 0x52, 0x4F, 0x57, 0x42, 0x59, 0x54,
                                0x45, 0x53,
                            ]),
                            Token::WildcardCountRange(7, 8),
                            Token::Literal(&[
                                0x0A, 0x54, 0x4F, 0x54, 0x41, 0x4C, 0x52, 0x4F, 0x57, 0x42, 0x59,
                                0x54, 0x45, 0x53,
                            ]),
