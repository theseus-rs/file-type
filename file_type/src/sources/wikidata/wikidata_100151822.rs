...
pub(crate) const WIKIDATA_100151822: FileFormat = FileFormat {
    id: 100_151_822,
    puid: "wikidata/100151822",
        ...
        byte_sequences: &[ByteSequence {
            ...
            regex: Regex {
                tokens: &[Token::Literal(&[
                    ...
                    0x0A, 0x3C, 0x6D, 0x75, 0x76, 0x65, 0x65, 0x50, 0x72, 0x6F, 0x6A, 0x65, 0x63,
                    0x74, 0x3E, 0x3C, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6F, 0x6E, 0x3E,
                ])],
            },
        }],
    }],
