...
pub(crate) const PRONOM_927: FileFormat = FileFormat {
    id: 927,
            ...
            byte_sequences: &[ByteSequence {
                ...
                regex: Regex {
                    tokens: &[
                        ...
                        Token::Literal(&[
                            0x00, 0xFE, 0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
                        ]),
            ...
            byte_sequences: &[ByteSequence {
                ...
                regex: Regex {
                    tokens: &[
                        ...
                        Token::WildcardCountRange(0, 999_999),
                        Token::Literal(&[
                            0x00, 0xFE, 0x00, 0x04, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                        ]),
                        Token::WildcardCount(36),
            ...
            byte_sequences: &[ByteSequence {
                ...
                regex: Regex {
                    tokens: &[
                        ...
                        Token::AnyWildcard,
                        Token::Literal(&[
                            0x4E, 0x49, 0x4B, 0x4F, 0x4E, 0x20, 0x43, 0x4F, 0x52, 0x50, 0x4F, 0x52,
                            0x41, 0x54, 0x49, 0x4F, 0x4E, 0x00, 0x4E, 0x49, 0x4B, 0x4F, 0x4E, 0x20,
                            0x44, 0x31, 0x20, 0x00,
                        ]),
