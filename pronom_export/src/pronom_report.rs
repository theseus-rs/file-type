use crate::report_format_detail::ReportFormatDetail;
use serde::{Deserialize, Serialize};

#[derive(Clone, Debug, Default, Deserialize, Serialize)]
#[serde(rename = "PRONOM-Report")]
pub struct PronomReport {
    #[serde(rename = "report_format_detail")]
    detail: ReportFormatDetail,
}

impl PronomReport {
    /// Returns the report format detail.
    pub fn detail(&self) -> &ReportFormatDetail {
        &self.detail
    }
}
