...
pub(crate) const PRONOM_1058: FileType = FileType {
        ...
        signatures: &[Signature {
            byte_sequences: &[ByteSequence {
                ...
                regex: Regex {
                    tokens: &[
                        Token::Literal(&[
                            0x4F, 0x46, 0x58, 0x48, 0x45, 0x41, 0x44, 0x45, 0x52, 0x3D,
                        ]),
                        Token::Any(&[&[Token::Literal(&[0x22])], &[Token::Literal(&[0x27])]]),
                        Token::Literal(&[0x32, 0x30, 0x30]),
                        Token::Any(&[&[Token::Literal(&[0x22])], &[Token::Literal(&[0x27])]]),
                        Token::Literal(&[
                            0x0D, 0x0A, 0x56, 0x45, 0x52, 0x53, 0x49, 0x4F, 0x4E, 0x3D,
                        ]),
                        Token::Any(&[&[Token::Literal(&[0x22])], &[Token::Literal(&[0x27])]]),
                        Token::Literal(&[0x32, 0x31, 0x31]),
                        Token::Any(&[&[Token::Literal(&[0x22])], &[Token::Literal(&[0x27])]]),
                        Token::Literal(&[
