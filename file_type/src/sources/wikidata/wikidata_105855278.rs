...
pub(crate) const WIKIDATA_105855278: FileFormat = FileFormat {
    id: 105_855_278,
    puid: "wikidata/105855278",
    name: "OpenDocument Flat XML Presentation",
    extensions: &["fodp"],
    media_types: &["application/vnd.oasis.opendocument.presentation-flat-xml"],
