...
pub(crate) const PRONOM_2621: FileType = FileType {
            ...
            byte_sequences: &[
                ByteSequence {
                    ...
                    regex: Regex {
                        tokens: &[
                            Token::Literal(&[
                                0x3C, 0x50, 0x41, 0x4D, 0x44, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74,
                                0x3E,
                            ]),
                            Token::WildcardCountRange(10, 200),
                            Token::Literal(&[
                                0x3C, 0x4D, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x20, 0x64,
                                0x6F, 0x6D, 0x61, 0x69, 0x6E, 0x3D, 0x22,
                            ]),
                            Token::Any(&[
