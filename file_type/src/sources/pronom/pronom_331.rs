...
pub(crate) const PRONOM_331: FileFormat = FileFormat {
    id: 331,
                ...
                regex: Regex {
                    tokens: &[
                        Token::Literal(&[
                            ...
                            0x2E, 0x30, 0x20, 0x45, 0x50, 0x53, 0x46, 0x2D, 0x33, 0x2E, 0x30,
                        ]),
                        Token::Any(&[
                            &[Token::Literal(&[0x0D])],
                            &[Token::Literal(&[0x0A])],
                ...
                ByteSequence {
                    ...
                    regex: Regex {
                        tokens: &[
                            ...
                            Token::Literal(&[0x20, 0x45, 0x50, 0x53, 0x46, 0x2D, 0x33, 0x2E, 0x30]),
                            Token::Any(&[
                                &[Token::Literal(&[0x0D])],
                                &[Token::Literal(&[0x0A])],
                                &[Token::Literal(&[0x0D, 0x0A])],
            ...
            byte_sequences: &[ByteSequence {
                ...
                regex: Regex {
                    tokens: &[
                        Token::Literal(&[
                            0x25, 0x21, 0x50, 0x53, 0x2D, 0x41, 0x64, 0x6F, 0x62, 0x65, 0x2D, 0x33,
                            0x2E, 0x31, 0x20, 0x45, 0x50, 0x53, 0x46, 0x2D, 0x33, 0x2E, 0x30,
                        ]),
                        Token::Any(&[
                            &[Token::Literal(&[0x0D])],
                            &[Token::Literal(&[0x0A])],
