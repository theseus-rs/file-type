...
pub(crate) const WIKIDATA_26543628: FileFormat = FileFormat {
    id: 26_543_628,
    puid: "wikidata/26543628",
    name: "Portable Document Format/Archive, version 1 Basic",
    extensions: &["pdf", "pdf", "pdf"],
    media_types: &["application/pdf", "application/pdf", "application/pdf"],
    internal_signatures: &[
        InternalSignature {
