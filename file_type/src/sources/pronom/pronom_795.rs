...
pub(crate) const PRONOM_795: FileType = FileType {
                ...
                byte_sequences: &[ByteSequence {
                    ...
                    regex: Regex {
                        tokens: &[
                            ...
                            Token::Literal(&[
                                0x12, 0xC6, 0x01, 0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x01, 0x00,
                                0x00,
                            ]),
                        ],
                    },
                ...
                byte_sequences: &[ByteSequence {
                    ...
                    regex: Regex {
                        tokens: &[
                            ...
                            Token::WildcardCountRange(0, 4_080),
                            Token::Literal(&[
                                0xC6, 0x12, 0x00, 0x01, 0x00, 0x00, 0x00, 0x04, 0x01, 0x01, 0x00,
                                0x00,
                            ]),
                        ],
                    },
