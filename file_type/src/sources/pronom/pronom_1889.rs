...
pub(crate) const PRONOM_1889: FileFormat = FileFormat {
    id: 1_889,
        ...
        byte_sequences: &[ByteSequence {
            ...
            regex: Regex {
                tokens: &[
                    ...
                    Token::Any(&[
                        &[Token::Literal(&[
                            0x41, 0x75, 0x74, 0x6F, 0x45, 0x76, 0x65, 0x6E, 0x74, 0x57, 0x69, 0x72,
                            0x65, 0x75, 0x70,
                        ])],
                        &[Token::Literal(&[
                        ...
                        &[Token::Literal(&[
                            0x43, 0x6F, 0x64, 0x65, 0x46, 0x69, 0x6C, 0x65, 0x42, 0x61, 0x73, 0x65,
                            0x43, 0x6C, 0x61, 0x73, 0x73,
                        ])],
                        &[Token::Literal(&[
                            0x43, 0x6F, 0x6D, 0x70, 0x69, 0x6C, 0x61, 0x74, 0x69, 0x6F, 0x6E, 0x4D,
                            0x6F, 0x64, 0x65,
                        ])],
                        &[Token::Literal(&[
                        ...
                        &[Token::Literal(&[
                            0x45, 0x6E, 0x61, 0x62, 0x6C, 0x65, 0x54, 0x68, 0x65, 0x6D, 0x69, 0x6E,
                            0x67,
                        ])],
                        &[Token::Literal(&[
                            0x45, 0x6E, 0x61, 0x62, 0x6C, 0x65, 0x56, 0x69, 0x65, 0x77, 0x53, 0x74,
                            0x61, 0x74, 0x65,
                        ])],
                        &[Token::Literal(&[
                        ...
                        &[Token::Literal(&[
                            0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x53, 0x63, 0x68, 0x65, 0x6D, 0x61,
                        ])],
                        &[Token::Literal(&[
                            0x57, 0x61, 0x72, 0x6E, 0x69, 0x6E, 0x67, 0x4C, 0x65, 0x76, 0x65, 0x6C,
                        ])],
                    ]),
                    Token::Literal(&[0x3D]),
                ],
