...
const SPARQL_URL: &str = "https://query.wikidata.org/sparql?query=SELECT%20DISTINCT%20%3FidExtension%20%3Fextension%20%3FmediaType%20%3FidExtensionLabel%20%3FfileSignature%0AWHERE%0A%7B%0A%20%20%23%20Find%20entries%20that%20are%20file%20formats%20or%20instances%20of%20subclasses%20of%20file%20formats%0A%20%20%3FidExtension%20wdt%3AP31%2Fwdt%3AP279*%20wd%3AQ235557%20%3B%0A%0A%20%20%23%20Optional%3A%20Get%20the%20extension%20if%20available%0A%20%20OPTIONAL%20%7B%20%3FidExtension%20wdt%3AP1195%20%3Fextension%20%7D%0A%20%0A%20%23%20Optional%3A%20Get%20the%20MIME%2Fmedia%20type%20if%20available%0A%20%20OPTIONAL%20%7B%20%3FidExtension%20wdt%3AP1163%20%3FmediaType%20%7D%0A%20%0A%20%23%20Optional%3A%20Get%20file%20signatures%2Fmagic%20numbers%20if%20available%0A%20%20OPTIONAL%20%7B%20%3FidExtension%20wdt%3AP4152%20%3FfileSignature%20%7D%0A%20%0A%20%23%20Optional%3A%20Get%20byte%20sequences%20if%20available%0A%20%20OPTIONAL%20%7B%20%3FidExtension%20wdt%3AP5933%20%3FbyteSequence%20%7D%0A%20%0A%20%23%20Optional%3A%20Get%20offset%20patterns%20if%20available%0A%20%20OPTIONAL%20%7B%0A%20%20%20%20%3FidExtension%20p%3AP5933%20%3Fstatement%20.%0A%20%20%20%20%3Fstatement%20ps%3AP5933%20%3FoffsetPattern%20%3B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20pq%3AP4153%20%3Foffset%20.%0A%20%20%7D%0A%20%0A%20%23%20Optional%3A%20Get%20magic%20numbers%20if%20available%20(different%20from%20file%20signatures)%0A%20%20OPTIONAL%20%7B%20%3FidExtension%20wdt%3AP3508%20%3FmagicNumber%20%7D%0A%20%0A%20%23%20Optional%3A%20Get%20format%20identification%20notes%20if%20available%0A%20%20OPTIONAL%20%7B%20%3FidExtension%20wdt%3AP2561%20%3FidentificationNote%20%7D%0A%20%0A%20%23%20Add%20labels%20in%20English%0A%20%20SERVICE%20wikibase%3Alabel%20%7B%20bd%3AserviceParam%20wikibase%3Alanguage%20%22en%22%20%7D%0A%7D%0AGROUP%20BY%20%3FidExtension%20%3Fextension%20%3FmediaType%20%3FidExtensionLabel%20%3FfileSignature%0AORDER%20BY%20%3Fextension%20%3FmediaType";

// SPARQL
//
// SELECT DISTINCT ?idExtension ?extension ?mediaType ?idExtensionLabel ?fileSignature
// WHERE
// {
//   # Find entries that are file formats or instances of subclasses of file formats
//   ?idExtension wdt:P31/wdt:P279* wd:Q235557 ;
//
...
// }
// GROUP BY ?idExtension ?extension ?mediaType ?idExtensionLabel ?fileSignature
