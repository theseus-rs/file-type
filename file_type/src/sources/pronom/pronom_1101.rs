...
pub(crate) const PRONOM_1101: FileType = FileType {
            ...
            byte_sequences: &[ByteSequence {
                ...
                regex: Regex {
                    tokens: &[
                        ...
                        Token::Literal(&[
                            0x5C, 0x73, 0x74, 0x73, 0x68, 0x66, 0x64, 0x62, 0x63, 0x68,
                        ]),
                        Token::WildcardCountRange(1, 5),
                        Token::Literal(&[
                            0x5C, 0x73, 0x74, 0x73, 0x68, 0x66, 0x6C, 0x6F, 0x63, 0x68,
                        ]),
                        Token::WildcardCountRange(1, 5),
                        Token::Literal(&[
                            0x5C, 0x73, 0x74, 0x73, 0x68, 0x66, 0x68, 0x69, 0x63, 0x68,
                        ]),
                        Token::WildcardCountRange(1, 5),
                        ...
                        Token::Any(&[
                            &[Token::Literal(&[
                                0x2A, 0x5C, 0x63, 0x6F, 0x6C, 0x6F, 0x72, 0x73, 0x63, 0x68, 0x65,
                                0x6D, 0x65, 0x6D, 0x61, 0x70, 0x70, 0x69, 0x6E, 0x67,
                            ])],
                            &[Token::Literal(&[0x61, 0x66, 0x65, 0x6C, 0x65, 0x76])],
                            &[Token::Literal(&[
                                0x2A, 0x5C, 0x64, 0x61, 0x74, 0x61, 0x73, 0x74, 0x6F, 0x72, 0x65,
                            ])],
                            &[Token::Literal(&[
                                0x2A, 0x5C, 0x64, 0x65, 0x66, 0x63, 0x68, 0x70,
                            ])],
                        ]),
                    ],
                },
