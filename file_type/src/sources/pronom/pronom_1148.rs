...
pub(crate) const PRONOM_1148: FileType = FileType {
            ...
            byte_sequences: &[
                ByteSequence {
                    ...
                    regex: Regex {
                        tokens: &[
                            Token::Literal(&[
                                0x1C, 0x01, 0x00, 0x00, 0x02, 0x00, 0x04, 0x1C, 0x01, 0x14, 0x00,
                                0x02, 0x00, 0x14, 0x1C, 0x01, 0x16, 0x00, 0x02, 0x00, 0x09, 0x1C,
                                0x01, 0x1E, 0x00, 0x0A, 0x46, 0x72, 0x65, 0x65, 0x48, 0x61, 0x6E,
                                0x64, 0x31, 0x31, 0x1C, 0x01, 0x28, 0x00, 0x08,
                            ]),
